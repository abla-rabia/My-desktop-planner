...
public class PlanningActuelController implements Initializable {
    User user=AccueilController.getUser();
    Planning planningAct=user.getPlanningActuel();
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        System.out.println(planningAct.getName());
    ...
    @FXML
    public  void newtacheOnClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("newTache.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
    ...
    @FXML
    public  void newprojetOnClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("newProjet.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        stage.setScene(scene);
